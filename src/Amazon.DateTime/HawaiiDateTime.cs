namespace Amazon.DateTime
{
    ...
    [Serializable]
    [System.ComponentModel.TypeConverter(typeof(ComponentModelDateTimeConverter<HawaiiDateTime>))]
    ...
    public class HawaiiDateTime : DateTimeBase
    {
        ...
        /// <summary>
        /// Get the Current 'Now' time in Hawaiian Timezone
        /// </summary>
        public static HawaiiDateTime Now => Convert(DateTime.UtcNow);

        /// <summary>
        /// Get the Current 'Today' date in Hawaiian Timezone
        /// </summary>
        public static HawaiiDateTime Today => (HawaiiDateTime)Now.Date;
